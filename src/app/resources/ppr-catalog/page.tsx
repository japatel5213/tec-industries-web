...
const ASSETS = {
  system: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663160765145/QbOvddWIZIVIuIGv.jpg',
  fusion: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663160765145/TagwZVxAYxGEZUsG.jpg',
  material: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663160765145/tKtWtaVZIbBGUHWC.jpg',
};

const CATALOGUE_ITEMS = [
  { family: 'PPR Pipes', group: 'Pipes', description: 'Green and blue triple-layer PPR pipe lengths for industrial utility and project conversations.', detail: 'Request the applicable nominal size, project quantity and current documentation.' },
  { family: 'Elbows', group: 'Fittings', description: 'Direction-change fittings for PPR route planning and installation layouts.', detail: 'Share the required angle and line-size context for review.' },
  { family: 'Tees', group: 'Fittings', description: 'Branching fittings for distribution, equipment connections and plant utility routes.', detail: 'Confirm the branch configuration and size combination with TEC.' },
  { family: 'Reducers', group: 'Fittings', description: 'Transition fittings for a controlled change in nominal pipe size.', detail: 'Request reducer combinations against the main and branch line requirements.' },
  { family: 'Couplings', group: 'Fittings', description: 'Straight joining fittings for continuous PPR pipe runs and repair planning.', detail: 'Share the pipe size and service condition for a matching discussion.' },
  { family: 'Unions', group: 'Fittings', description: 'Detachable system connections for planned access and maintenance locations.', detail: 'Confirm connection type and access requirements before selection.' },
  { family: 'Flanges', group: 'Fittings', description: 'Flanged PPR transition points for equipment, valve and service-line interfaces.', detail: 'Request the matching interface and project context for review.' },
  { family: 'PPR Valves', group: 'Fittings', description: 'PPR-compatible valve families for isolation and utility service control.', detail: 'Share the operating-medium and control requirement for the right discussion.' },
  { family: 'Transition Fittings', group: 'Fittings', description: 'System transitions for selected equipment, threaded or mixed-material interfaces.', detail: 'Request a project-specific review before procurement.' },
];
