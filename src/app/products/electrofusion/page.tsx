...
export const metadata: Metadata = { title: 'Electrofusion Fittings', description: 'TEC INDUSTRIES Electrofusion Fittings — precision PE fittings for leak-proof joints in water and gas pipe networks. Couplings, saddles, elbows, and tees. Manufactured in Vapi, Gujarat.' };
